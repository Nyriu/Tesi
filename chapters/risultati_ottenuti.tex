...
% scarto sin - ricostruita
% diff abs   - blob detection
...
\begin{figure}[ht] % TODO
  \begin{center}
    \begin{tabular}{cc}
      ...
      \centtering\includegraphics[width=.3\textwidth]{128___1315_1_0_1_OnLineAnalysis_in} &
      \centtering\includegraphics[width=.3\textwidth]{128___1315_1_0_1_OnLineAnalysis_out} \\
      \centtering\includegraphics[width=.3\textwidth]{128___1315_1_0_1_OnLineAnalysis_in} &
      \centtering\includegraphics[width=.3\textwidth]{128___1315_1_0_1_OnLineAnalysis_out}
