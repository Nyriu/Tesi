...
\section{Il modello}
\todo[inline]{spostare dettagli dell'archittura il autoendoer}
\todo[inline]{lasciare qua i dettagli sull'addestramento}
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=.58\textwidth]{ae16}
...
\begin{figure}[ht] % TODO sarebbe da cambiare
  \begin{center}
    \includegraphics[width=0.31\textwidth]{loss_plot}
...
\todo[inline]{spostare Post-poressig nella parte del dataset}
