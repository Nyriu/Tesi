...
Tali dati numerici sono stati ottenuti soltanto quando le immagini-differenza sono risultate soddisfacenti e si è quindi potuto sviluppare l'algoritmo di \textit{post-processing}. \todo{ref a pagina di descrizione del post-processing}
...
\todo{rimuovere ref a figura e dire "al modello descritto precedentemente/a pagina tot bla bla"}
