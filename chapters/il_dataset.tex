...
In figura~\ref{fig:hough_parametr_coni} è illustrata una rappresentazione di questo spazio.
...
\begin{figure}[ht]
  \begin{center}
      ...
      \caption{Spazio dei parametri di Hough per le circonferenze con raggio dato}
...
\begin{figure}[ht]
  \begin{center}
      \includegraphics[width=0.6\textwidth]{example-image}
      \caption{Spazio dei parametri di Hough per le circonferenze con raggio ignoto}
      \label{fig:hough_parametr_coni}
  \end{center}
\end{figure}
...
La \textit{Data Augmentation} è una tecnica che permette di aumentare le dimensioni del \textit{dataset}, generando nuovi elementi in modo che 
Non è una novità che chi affronta
% TODO ref a documento magari
