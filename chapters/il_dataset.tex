...
Questa sezione è divisa in due parti: nella prima verranno illustrate alcune tra le principali tecniche di \textit{Digital Image Preprocessing} nonché di \textit{Machine Vision}, esponendo i dettagli matematici ed esplorando le loro applicazioni; nella seconda si spiegherà quali di queste tecniche, in che ordine e per quali motivi sono state utilizzate.
...
Ora verranno introdotti alcuni algoritmi fondamentali nel campo del \textit{Machine Vision}
