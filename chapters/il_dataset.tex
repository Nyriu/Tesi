...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.35\textwidth]{GRAY_low_contrast}
    \includegraphics[width=0.35\textwidth]{eqHist_example}
    \includegraphics[width=0.35\textwidth]{pre_eq_hist}
    \includegraphics[width=0.35\textwidth]{post_eq_hist}
