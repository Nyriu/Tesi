...
\paragraph{Convoluzioni} \label{conv_para}
...
Solitamente i \textit{kernel} hanno dimensione $3$x$3$ o $5$x$5$.%\todo{ref alla risorsa?}
...
\begin{figure}[ht] % TODO
  ...
  \begin{subfigure}{.49\linewidth}
    \centering\includegraphics[width=\textwidth]{RGB}
    \caption{Immagine originale}
  \end{subfigure}
  \begin{subfigure}{.49\linewidth}
    \centering\includegraphics[width=\textwidth]{mask}
    \caption{Maschera binaria}
  \end{subfigure}
  \begin{subfigure}{.49\linewidth}
    \centering\includegraphics[width=\textwidth]{masked}
...
\begin{figure}[ht]
  \begin{center}
  \begin{subfigure}{.49\linewidth}
    \centering\includegraphics[width=\textwidth]{GRAY_low_contrast}
    \caption{Immagine originale}
  \end{subfigure}
  \begin{subfigure}{.49\linewidth}
    \centering\includegraphics[width=\textwidth]{eqHist_example}
    \caption{Immagine equalizzata}
  \end{subfigure}
  \begin{subfigure}{.73\linewidth}
    \centering\includegraphics[width=\textwidth]{pre_eq_hist}
    \caption{Istogramma dell'immagine originale}
    \label{fig:hist_pre_eq_example}
  \end{subfigure}
  \begin{subfigure}{.73\linewidth}
    \centering\includegraphics[width=\textwidth]{post_eq_hist}
...
Conosciuto anche come \textit{Gaussian smoothing} o \textit{Gaussian filtering}~\cite{gaussian-filtering}, il \textit{Gaussian blur} permette di sfocare un immagine sfruttando una convoluzione con \textit{kernel} gaussiano.
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \begin{subfigure}{.49\linewidth}
    \centering\includegraphics[width=\textwidth]{gx}
    \caption{Risultato rispetto ad $x$}
  \end{subfigure}
  \begin{subfigure}{.49\linewidth}
    \centering\includegraphics[width=\textwidth]{gy}
    \caption{Risultato rispetto ad $y$}
  \end{subfigure}
  \begin{subfigure}{.49\linewidth}
    \centering\includegraphics[width=\textwidth]{g}
...
\begin{figure}[ht]
  \begin{center}
    \begin{subfigure}{.4\linewidth}
      \centering\includegraphics[width=\textwidth]{raggio_angolo}
      \caption{}
      \label{fig:hough_parametr_parametr}
    \end{subfigure}
    \begin{subfigure}{.4\linewidth}
      \centering\includegraphics[width=\textwidth]{raggio_angolo_sp}
      \caption{}
...
\begin{figure}[ht] % TODO
  \begin{center}
    \begin{subfigure}{.49\linewidth}
      \centering\includegraphics[width=\textwidth]{128___16740_0_0_1_OnLineAnalysis_0_hough_original}
      \caption{Immagine originale}
      \label{fig:p1_originale}
    \end{subfigure}
    \begin{subfigure}{.49\linewidth}
      \centering\includegraphics[width=\textwidth]{128___16740_0_0_1_OnLineAnalysis_0_hough}
      \caption{Immagine dopo il centramento}
      \label{fig:p1_centrata}
    \end{subfigure}
    \begin{subfigure}{.49\linewidth}
      \centering\includegraphics[width=\textwidth]{128___16740_0_0_1_OnLineAnalysis_0_hough_temp_pre_houghCirc}
...
\begin{figure}[ht] % TODO
  \begin{center}
    \begin{subfigure}{.49\linewidth}
      \centering\includegraphics[width=\textwidth]{128___289_1_0_1_OnLineAnalysis}
      \caption{Immagine originale con alta luminosità}
      \label{fig:p2_originale_lum}
    \end{subfigure}
    \begin{subfigure}{.49\linewidth}
      \centering\includegraphics[width=\textwidth]{128___289_1_0_1_OnLineAnalysis_1_hist}
      \caption{Risultato dell'equalizzazione dell'immagine con alta luminosità}
      \label{fig:p2_equalizzata_lum}
    \end{subfigure}

    \begin{subfigure}{.49\linewidth}
      \centering\includegraphics[width=\textwidth]{128___290_1_1_1_OnLineAnalysis}
      \caption{Immagine originale con bassa luminosità}
      \label{fig:p2_originale_scura}
    \end{subfigure}
    \begin{subfigure}{.49\linewidth}
      \centering\includegraphics[width=\textwidth]{128___290_1_1_1_OnLineAnalysis_1_hist}
  ...
  \begin{center}
    \begin{tabular}{c}
      \begin{subfigure}{\linewidth}
        \begin{center}
          \includegraphics[width=.24\textwidth]{128___22886_1_1_1_OnLineAnalysis_in}
          \includegraphics[width=.24\textwidth]{128___22886_1_1_1_OnLineAnalysis_out}
        \end{center}
      \end{subfigure} \\ \\

      \begin{subfigure}{\linewidth}
        \begin{center}
          \includegraphics[width=.24\textwidth]{128___33667_0_0_1_OnLineAnalysis_in}
          \includegraphics[width=.24\textwidth]{128___33667_0_0_1_OnLineAnalysis_out}
        \end{center}
      \end{subfigure}
...
%L'algoritmo di \textit{post-processing} è stato sviluppato usando immagini-differenza generate da scarti sintetici, perché risultano più pulite.
...
\begin{figure}[ht] % TODO
  \begin{center}
    \begin{tabular}{cc}
      ...
      \includegraphics[width=.24\textwidth]{128___17299_0_1_1_OnLineAnalysis_con_colla_in} &
      \includegraphics[width=.24\textwidth]{128___17299_0_1_1_OnLineAnalysis_con_colla_out} \\
      \includegraphics[width=.24\textwidth]{128___17299_0_1_1_OnLineAnalysis_con_colla_to_blob} &
      \includegraphics[width=.24\textwidth]{128___17299_0_1_1_OnLineAnalysis_con_colla_detected}
