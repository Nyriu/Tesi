...
\clearpage % TODO rimuovere se necessario

\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{max-pool}
...
Più interessanti sono i \textit{transposed convolutional layers} il cui scopo è simulare l'opposto di un'operazione convolutiva.
Osservando nuovamente quanto spiegato in \cite{conv_arithm}
\todo[inline]{WIP}
