...
\graphicspath{{./figure/}, {./figure/preprocessing/}}
%\usepackage{epstopdf}
...
\setuptodonotes{noline, shadow, bordercolor=black}
...
%\input{capitolo1}
%\input{capitolo2}
\input{./chapters/il_problema}

\input{./chapters/il_dataset}

\input{./chapters/gli_autoencoder}

\input{./chapters/valutazione_sperimentale}

\input{./chapters/risultati_ottenuti}

\input{./chapters/metodi_alternativi}
\input{./chapters/ulteriori_risultati}
